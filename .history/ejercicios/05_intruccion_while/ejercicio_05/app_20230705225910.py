...
Se deberá validar que la letra sea 'U', '' o ‘N’ (en mayusculas) 
...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra=prompt(title="validar",prompt="ingrese una letra: 'U', '' o ‘N’").upper()
        while( letra='U' and letra=''and letra=‘N’ ):
        letra=prompt(title="validar",prompt="Error, ingrese una letra: 'U', '' o ‘N’").upper()
