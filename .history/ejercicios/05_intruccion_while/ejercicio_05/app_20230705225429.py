...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra=prompt(title="validar",prompt="ingrese una letra: ‘U’, ‘T’ o ‘N’").upper()
        while( letra=‘U’ and letra=‘T’and letra=‘N’ )
        letra=prompt(title="validar",prompt="Error, ingrese una letra: ‘U’, ‘T’ o ‘N’").upper()
    alert(title="veificacion",me)    
