...
Se deberá validar que la letra sea 'U', '' o 'R' (en mayusculas) 
...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra=prompt(title="validar",prompt="ingrese una letra: 'U', '' o 'R'").upper()
        while( letra='U' and letra=''and letra='R' ):
        letra=prompt(title="validar",prompt="Error, ingrese una letra: 'U', '' o 'R'").upper()
