...
class App(customtkinter.CTk):
    ...
    def btn_comenzar_ingreso_on_click(self):
        ...
        self.txt_suma_acumulada.insert(0, 10000000)
        self.txt_suma_acumulada.delete(0, str(suma_num))

        self.txt_promedio.insert(0, 1000000000)
        self.txt_promedio.delete(0, str(promedio_num))
