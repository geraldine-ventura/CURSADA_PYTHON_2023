...
class App(customtkinter.CTk):
    ...
    def btn_comenzar_ingreso_on_click(self):
        ...
        self.txt_suma_acumulada.delete(0, 'end')  # Limpiar el contenido actual del widget
        self.txt_suma_acumulada.insert(0, str(suma_num))  # Insertar el nuevo valor en el widget
