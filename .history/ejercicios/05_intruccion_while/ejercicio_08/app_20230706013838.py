...
class App(customtkinter.CTk):
    ...
    def btn_comenzar_ingreso_on_click(self):
        ...
        while(flag_continuar):
            numeros_str=prompt(title="solicitud",prompt="Ingrese los numeros que desea: ")
        ...
        self.txt_suma_acumulada.delete(0,suma_positivos)  
        
        self.txt_producto.insert(0,10000000)
        self.txt_producto.delete(0,multiplicacion_neg)
