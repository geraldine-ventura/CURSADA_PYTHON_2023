        ...
        while flag_continuar:
            ...
            if numeros_str == None or numeros_str == 0:
                ...
                if numeros_num > 0:
                    ...
                    if(multiplicacion_neg==None)
                    multiplicacion_neg = multiplicacion_neg * numeros_num

            self.txt_suma_acumulada.delete(0, 100000)
            self.txt_suma_acumulada.insert(0, str(suma_positivos))

            self.txt_producto.delete(0, 10000000)
            self.txt_producto.insert(0, str(multiplicacion_neg))
