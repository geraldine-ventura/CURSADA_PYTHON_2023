    ...
    def btn_informar_on_click(self):
        ...
        match(meses):
                case ['Enero','Febrero','Marzo','Abril','Mayo']:
                    alert_library.alert (title='dias', message='Falta para el invierno..')

                case  ['Junio','Julio','Agosto']:
                    alert_library.alert (title='dias', message='¡Abrígate que hace frío!')

                case _:
                    alert_library.alert (title='dias', message='Ya pasamos frío, ahora calor!!')
