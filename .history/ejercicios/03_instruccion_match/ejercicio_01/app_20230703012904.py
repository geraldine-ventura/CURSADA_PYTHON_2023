...
en función del mes seleccionado:
    ...
    Si el mes seleccionado es Diciembre: ‘’
Felices fiestas!!!
...
class App(customtkinter.CTk):
    ...
    def btn_informar_on_click(self):
        ...
        match(mes):
            case "Enero"
                alert(title="comentario", message="Que comiences bien el año!!!" )
            case "Marzo"
                alert(title="comentario", message="a clases!!")
            case "Julio"
                alert(title="comentario", message="se vienen las vacaciones!" )
            case "Diciembre"
                alert(title="comentario", message="Felices fiestas!!!!" )
