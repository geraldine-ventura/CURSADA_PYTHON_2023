...
---
Enunciado:
Al presionar el botón  'Mostrar', se deberejercicios/01_entrada_salida/ejercicio_05/app.á obtener tanto el nombre como la edad contenida en 
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        alert(title="Info",message = saludo)
